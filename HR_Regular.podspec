...
#====================================================================
s.source           = { :git => 'https://github.com/iOS-Risenb/HR_Regular.git', :tag => s.version.to_s }
...
#====================================================================
# 'h,m' 之间不能有空格
s.source_files = 'HR_Regular/Classes/**/*.{h,m}'


# 3.3:资源文件
#====================================================================
# 'HR_Regular' 为存储的 bundleName
#s.resource_bundles = {
#    'HR_Regular' => ['HR_Regular/**/*.{storyboard,xib,png,plist}']
#}
